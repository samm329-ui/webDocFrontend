        ...
        <section className="py-12 md:py-20 bg-background">
            <div className="container px-4 mx-auto">
                <div className="text-center max-w-2xl mx-auto mb-8 md:mb-16">
                    <h2 className="text-2xl md:text-3xl font-bold font-headline mb-4">What Our Patients Say</h2>
                    ...
                    <div className="flex gap-4">
                        {reviews.map((review, index) => (
                            <div key={index} className="flex-[0_0_85%] min-w-0">
                                <Card className="border-none shadow-lg bg-card/50 backdrop-blur-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300 h-full">
                                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                                        <Quote size={60} />
                                    </div>
                                    <CardContent className="p-6 flex flex-col justify-between relative z-10 h-full">
                                        <div className="mb-4">
                                            ...
                                            <p className="text-base text-muted-foreground italic leading-relaxed">"{review.text}"</p>
                                        </div>
                                        <div>
